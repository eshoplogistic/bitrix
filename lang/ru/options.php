...
$MESS['ESHOP_LOGISTIC_OPTIONS_INSTALL_DESC'] = "После установки модуля необходимо перейти на страницу настроек модуля «Настройки / Настройки модулей / Расчет доставки: Почта, СДЭК, DPD, Boxberry, Ozon Rocket, PickPoint, IML, Деловые Линии, ПЭК и др. после чего ввести данные для авторизации (Ключ API), который берется в личном кабинете eShopLogistic.</br>
...
При установке модуля создается поле заказа «eShopLogistic ПВЗ» в котором сохраняется выбранный ПВЗ. Для добавления параметра ПВЗ в почтовый шаблон, используйте данный символьный код: #ESHOPLOGISTIC_PVZ#.
";
...
$MESS['ESHOP_LOGISTIC_OPTIONS_MOMENTS_DESC'] = "В работе модуля используется кэширование результатов расчёта стоимости и сроков, поэтому в случае, если вы произвели какие-то изменения в личном кабинете eShopLogistic, необходимо очистить кэш.</br>
 Настройки / Настройки продукта / Настройки модулей / Расчет доставки: Почта, СДЭК, DPD, Boxberry, Ozon Rocket, PickPoint, IML, Деловые Линии, ПЭК и др.: кнопка «Очистить кэш».</br></br>";