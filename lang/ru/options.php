...
Для расчёта доставки сразу при загрузке корзины, нужно включить режим правки и нажать на редактирование поля оформления заказа (Редактировать параметры компонента). В появившемся окне найти поле: 'Когда рассчитывать доставки с внешними системами расчета' и выбрать в выпадающем списке значение: 'Рассчитывать сразу'.
";
