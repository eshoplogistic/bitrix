...
class KitTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'kit.png';
    protected static $isProfile = true;
    protected static $service = 'kit';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:kit_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_KIT_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_KIT_TERMINAL_CLASS_DESCRIPTION");
    }
