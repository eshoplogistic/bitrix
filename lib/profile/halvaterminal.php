...
class HalvaTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:halva_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_HALVA_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_HALVA_TERMINAL_CLASS_DESCRIPTION");
    }
