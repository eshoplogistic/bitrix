...
class DostavistaDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'dostavista.png';
    protected static $isProfile = true;
    protected static $service = 'dostavista';
    protected static $type = 'door';
    protected static $profileCode = 'eslogistic:dostavista_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DOSTAVISTA_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_DOSTAVISTA_DOOR_CLASS_DESCRIPTION");
    }
