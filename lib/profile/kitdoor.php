...
class KitDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:kit_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_KIT_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_KIT_DOOR_CLASS_DESCRIPTION");
    }
