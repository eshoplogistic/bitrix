...
class LogsisDoor extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'logsis.png';
    protected static $isProfile = true;
    protected static $service = 'logsis';
    protected static $type = 'door';
    protected static $profileCode = 'eslogistic:logsis_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_LOGSIS_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_LOGSIS_DOOR_CLASS_DESCRIPTION");
    }
