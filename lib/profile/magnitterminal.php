...
class MagnitTerminal extends \Bitrix\Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'magnit.png';
    protected static $isProfile = true;
    protected static $service = 'magnit';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:magnit_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_MAGNIT_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_MAGNIT_TERMINAL_CLASS_DESCRIPTION");
    }
