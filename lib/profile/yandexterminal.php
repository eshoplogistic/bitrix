...
class YandexTerminal extends Sale\Delivery\Services\Base
{
    protected $logotip;
    protected $logotipFileName = 'yandex.png';
    protected static $isProfile = true;
    protected static $service = 'yandex';
    protected static $type = 'terminal';
    protected static $profileCode = 'eslogistic:yandex_term';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_YANDEX_TERMINAL_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_YANDEX_TERMINAL_CLASS_DESCRIPTION");
    }
