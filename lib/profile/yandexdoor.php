...
class YandexDoor extends Sale\Delivery\Services\Base
{
    protected $logotip;
    ...
    protected static $profileCode = 'eslogistic:yandex_door';
    ...
    {
        return Loc::getMessage("ESHOP_LOGISTIC_YANDEX_DOOR_CLASS_TITLE");
    }

    public static function getClassDescription()
    {
        return Loc::getMessage("ESHOP_LOGISTIC_YANDEX_DOOR_CLASS_DESCRIPTION");
    }
